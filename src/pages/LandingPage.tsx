...
const LandingPage = () => {
  return (
    <div className="min-h-screen flex flex-col bg-primary-500 text-secondary-600">
      <Header />
      <main className="flex-grow flex justify-center items-center px-20">
        <div className="flex items-center gap-[140px]">
          ...
          <div className="text-left">
            ...
            {/* 아이콘 + 텍스트 */}
            <div className="flex gap-[40px] mb-10 text-white font-bold">
